...
| [davidluzgouveia/kanji-data](https://github.com/davidluzgouveia/kanji-data) (MIT) | `jlpt-kanji.json` | **Modern five-level JLPT kanji tags** (`jlpt_new`, derived from Jonathan Waller's tanos.co.uk lists: N5 79 · N4 166 · N3 367 · N2 367 · N1 1,232). KANJIDIC2's own `jlpt` field is the **pre-2010 four-level scale** (no N5, "N3" ≈ 181 chars) and is deliberately ignored — shipping it mislabeled every kanji level once |
