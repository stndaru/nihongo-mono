    ...
    <div className="grid gap-2.5 sm:grid-cols-2">
      {entries.map((entry) => (
        <Link
          ...
          className="block rounded-md border p-3 transition-colors duration-100 hover:border-primary/50 hover:bg-primary/5"
        >
          ...
          <div className="mt-2.5 empty:mt-0">
            <StrokeOrder char={entry.char} frameClass="size-7 rounded-sm" />
          </div>
        </Link>
      ))}
    </div>
